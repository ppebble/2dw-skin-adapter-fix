# 2D Wardrobe Skin Adapter Fix Development Guide
...
- Before claiming completion, run `node tests/2dw-skin-adapter-fix.test.cjs`, parse changed Lua when practical, and run `git diff --check`.
